...
const PrivacyPolicy: NextPage = () => {
  return (
    <div className='md:w-2/3 xl:w-2/5 md:mx-auto flex flex-col min-h-screen justify-center px-5 py-12'>
      <Head><Metadata title='CertiCovid - Privacy Policy'></Metadata></Head>
      <Seo title='CertiCovid - Privacy Policy' description='CertiCovid - Privacy Policy' />

      <main className='flex flex-col space-y-2'>
        <Header title='CertiCovid - Privacy Policy'></Header>
